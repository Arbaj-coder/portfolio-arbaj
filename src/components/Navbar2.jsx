      ...
      <nav className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white p-4 fixed w-full top-0 z-50 shadow transition-all">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-6 text-sm items-center">
            <li><a href="https://www.linkedin.com/in/arbaj-khan-8a9123260?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" className="hover:text-[#00ff88]">Linkedin</a></li>
            <li><a href="https://github.com/Arbaj-coder" target="_blank" className="hover:text-[#00ff88]">Github</a></li>
            <li>
